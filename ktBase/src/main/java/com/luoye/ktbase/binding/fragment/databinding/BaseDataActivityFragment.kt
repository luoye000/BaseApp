 ...
 * Created by: 
 * Time: 2023/4/7
 * user: 绑定activity 共享ViewModel
 *
 */
abstract class BaseDataActivityFragment<V : ViewDataBinding, MA : ViewModel> : Fragment() {

    protected lateinit var binding: V
        private set
    protected val viewModel by lazy { createActivityViewModel<MA>(this, 0) }
